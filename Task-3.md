...
|  `<пробел>Test5@mail.ru<пробел>`   | `1xX#$%^8`         | *Корректные данные (Пробел перед и после логина)* 		                      |		
...
|`11111111111111111111111111111111111111`| `1xX#$%^8`        | *Некорректный логин (Количество символов 40)*	    	        |	
...
|`Test5@mail.ru`     | `11111111111111111111111111111111111111`| *Некорректный пароль (Количество символов 40)*             | 	
